...
//[1] 函数: sub_67D8768 | 参数个数: 6 | 汇编骨架得分: 170
    "? ? ? D1 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? 91 F5 03 00 AA F9 03 01 AA E0 03 18 AA E1 03 02 AA F3 03 05 2A F4 03 04 AA F7 03 02 AA F6 03 03 AA"

//[2] 函数: sub_6E7BD9C | 参数个数: 6 | 汇编骨架得分: 170
    "? ? ? D1 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? 91 F8 03 00 AA E0 03 02 AA F3 03 05 2A F4 03 04 2A F5 03 03 2A F6 03 02 AA F7 03 01 AA C8 D1 C9 95 ? ? ? A9"

//[3] 函数: sub_6E7BF28 | 参数个数: 6 | 汇编骨架得分: 170
    "? ? ? D1 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? 91 F8 03 00 AA E0 03 01 AA F3 03 05 2A F4 03 04 AA F5 03 03 2A F6 03 02 2A F7 03 01 AA 65 D1 C9 95 ? ? ? A9"

//[4] 函数: sub_809D4D4 | 参数个数: 6 | 汇编骨架得分: 165
    "? ? ? D1 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? 91 A0 0C 00 B4 F5 03 05 2A FC 03 04 AA FA 03 03 AA F4 03 00 AA F9 03 02 AA F3 03 01 AA"

//[5] 函数: sub_6B43B9C | 参数个数: 6 | 汇编骨架得分: 160
    "? ? ? D1 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 54 D0 3B D5 F9 03 05 2A 88 16 40 F9 F7 03 04 2A F3 03 00 AA F6 03 03 AA F8 03 02 AA F5 03 01 AA"
    //1.26.30
